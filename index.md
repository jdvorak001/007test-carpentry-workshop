...
venue: "The Unseen University"        # brief name of host site without address (e.g., "Euphoric State University")
address: "The Dr. Fürst hall, CZ-25229 Dobrichovice"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "cz"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
...
humandate: "May 14, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 – 17:00 CEST"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Jan Dvořák", "Ilona Trtíková"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jakub Dvořák"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["jan.dvorak@ff.cuni.cz"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
